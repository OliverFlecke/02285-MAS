...
import mas.Command.Type;
import mas.entity.Agent;
...
public class Node {
	...
	/**
	 * Get a child node of this node. This copies the position of the boxes to an new array, 
	 * but passes a reference to the walls and the goals, as they are always at the same position.
